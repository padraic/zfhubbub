 ...
 * @version    $Id: AllTests.php 18370 2009-09-22 17:14:02Z padraic $
 */
...
require_once 'Zend/Feed/Pubsubhubbub/Storage/FilesystemTest.php';
require_once 'Zend/Feed/Pubsubhubbub/HubServerTest.php';
require_once 'Zend/Feed/Pubsubhubbub/HubServer/CallbackTest.php';
...
class Zend_Feed_Pubsubhubbub_AllTests
{
    ...
    public static function suite()
    {
        ...
        $suite->addTestSuite('Zend_Feed_Pubsubhubbub_Storage_FilesystemTest');
        $suite->addTestSuite('Zend_Feed_Pubsubhubbub_HubServerTest');
        $suite->addTestSuite('Zend_Feed_Pubsubhubbub_HubServer_CallbackTest');
