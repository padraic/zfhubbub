...
require_once 'Zend/Feed/Pubsubhubbub/HubServer/Callback.php';
require_once 'Zend/Feed/Pubsubhubbub/StorageInterface.php';
require_once 'Zend/Http/Client/Adapter/Test.php';

class Zend_Feed_Pubsubhubbub_HubServer_CallbackTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->_callback->setStorage(new Zend_Feed_Pubsubhubbub_Storage_Filesystem);
        $this->assertTrue($this->_callback->getStorage() instanceof Zend_Feed_Pubsubhubbub_Storage_Filesystem);
    }
    ...
    {
        $this->_callback->setPreferredVerificationMode(Zend_Feed_Pubsubhubbub::VERIFICATION_MODE_ASYNC);
        $this->assertEquals(Zend_Feed_Pubsubhubbub::VERIFICATION_MODE_ASYNC, $this->_callback->getPreferredVerificationMode());
    }
    ...
    {
        $this->assertEquals(Zend_Feed_Pubsubhubbub::VERIFICATION_MODE_SYNC, $this->_callback->getPreferredVerificationMode());
    }
