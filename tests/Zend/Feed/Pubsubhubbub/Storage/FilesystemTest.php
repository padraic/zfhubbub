...
class Zend_Feed_Pubsubhubbub_Storage_FilesystemTest extends PHPUnit_Framework_TestCase
{
    protected $_store = null;

    public function setUp()
    {
        $this->_store = new Zend_Feed_Pubsubhubbub_Storage_Filesystem;
    }

    public function testImplementsStorageInterface()
    {
        $this->assertTrue($this->_store instanceof Zend_Feed_Pubsubhubbub_StorageInterface);
    }
